...
(async () => {
  ...
  console.log('Starting MindAR feature target compilation for Shivam_Jewels_Invitation_Card.png (Full Invitation Card)...');
  ...
  const mindBufferArray = await page.evaluate(async () => {
    ...
    console.log(`Target Full Invitation Card image loaded: ${img.width}x${img.height}`);
